...
It does not aim to teach the use of the parametric strong-lens modeling code LENSTOOL. Instead, it provides a list of useful commands for new LENSTOOL users, covering general usage, DS9 interaction, source-plane reconstructions.
